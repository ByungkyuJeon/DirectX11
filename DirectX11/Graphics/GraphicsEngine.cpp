...
void GraphicsEngine::RenderFrame()
{
	...
	{
		renderable.Draw(this->deviceContext.Get(), cb_vs_vertexShader, DirectX::XMMatrixMultiply(this->mCamera->GetViewMatrix(), this->mCamera->GetProjectionMatrix()));
	}
...
bool GraphicsEngine::InitializeDirectX(HWND hwnd)
{
	try
	{
